...
function(check_dependency lib_for lib_dep)
	if (NRF5_LIBS MATCHES " ${lib_for} " AND NOT (NRF5_LIBS MATCHES " ${lib_dep} "))
		...
		message(WARNING "Adding dependency `${lib_dep_name}`, required by `${lib_for_name}`")
		set(NRF5_LIBS "${NRF5_LIBS} ${lib_dep} " PARENT_SCOPE)
		set(DEP_ADDED 1 PARENT_SCOPE)
	endif()
endfunction(check_dependency)

function(check_dependency_silent lib_for lib_what)
	if (NRF5_LIBS MATCHES " ${lib_for} " AND NOT (NRF5_LIBS MATCHES " ${lib_dep} "))
		set(NRF5_LIBS "${NRF5_LIBS} ${lib_dep} " PARENT_SCOPE)
		set(DEP_ADDED 1 PARENT_SCOPE)
	endif()
